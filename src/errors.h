...
#ifndef __ERRORS_H
#define __ERRORS_H
void colorPrefix(const char* prefix, int color, const char* fmt, va_list args, bool partial);
void colorPrefix(const char* prefix, int color, const char* fmt, va_list args);
